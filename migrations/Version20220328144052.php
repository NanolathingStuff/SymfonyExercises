 ...
 */
final class Version20220328144052 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lista_comuni CHANGE cod_fisco cod_fisco VARCHAR(255) NOT NULL, ADD PRIMARY KEY (cod_fisco)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lista_comuni DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE lista_comuni CHANGE cod_fisco cod_fisco VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE comune comune VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE provincia provincia VARCHAR(2) NOT NULL COLLATE `utf8mb4_unicode_ci`');
