 ...
 */
final class Version20220325081008 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fiscal_data ADD code VARCHAR(16) NOT NULL, ADD generation_date DATE NOT NULL, ADD ip VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE fiscal_data DROP code, DROP generation_date, DROP ip, CHANGE surname surname VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE born_place born_place VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE province province VARCHAR(2) NOT NULL COLLATE `utf8mb4_unicode_ci`');
